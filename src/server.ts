...
(function(){
  function setupCertificateViewer(){
    ...
    function sourceFor(btn){
      ...
      var img=(card&&card.querySelector('img')) || (btn.closest('#certification') && section && section.querySelector('button img')) || (qualification&&qualification.querySelector('img')) || (section&&section.querySelector('img'));
...
@media(max-width:767px){#portfolio-certificate-viewer-v1{padding:10px!important}#portfolio-certificate-viewer-v1 .pcv-dialog{width:100%!important;max-height:96vh!important;padding:10px!important}#portfolio-certificate-viewer-v1 .pcv-image{max-height:calc(96vh - 85px)!important}}
  ...
  const jsonLd = '<script type="application/ld+json">' + JSON.stringify({"@context":"https://schema.org","@type":"ProfilePage","@id":"https://haseenullah.vercel.app/#profilepage","url":"https://haseenullah.vercel.app/","name":title,"mainEntity":{"@type":"Person","@id":"https://haseenullah.vercel.app/#person","name":"Haseen Ullah","jobTitle":"HSE Officer / Safety Professional","url":"https://haseenullah.vercel.app/","email":"malikhaseen456@gmail.com","telephone":"+966 534 023 691","address":{"@type":"PostalAddress","addressLocality":"Al Wajh","addressRegion":"Tabuk","addressCountry":"SA"},"sameAs":["https://www.linkedin.com/in/haseen-ullah-hse"]}}) + '</script>';
